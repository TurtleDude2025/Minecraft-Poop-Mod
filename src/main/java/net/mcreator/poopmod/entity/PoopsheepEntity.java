...
package net.mcreator.poopmod.entity;
...
import net.mcreator.poopmod.entity.renderer.PoopsheepRenderer;
...
public class PoopsheepEntity extends PoopModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -6724096, new Item.Properties().group(PoopmodItemGroup.tab))
				.setRegistryName("poopsheep_spawn_egg"));
	}
