...
public class PoopwoodLogBlock extends PoopModModElements.ModElement {
	@ObjectHolder("poop_mod:poopwood_log")
	public static final Block block = null;
	public PoopwoodLogBlock(PoopModModElements instance) {
		super(instance, 27);
	}
