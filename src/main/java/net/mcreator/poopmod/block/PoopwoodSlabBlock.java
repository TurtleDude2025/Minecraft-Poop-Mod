...
public class PoopwoodSlabBlock extends PoopModModElements.ModElement {
	@ObjectHolder("poop_mod:poopwood_slab")
	public static final Block block = null;
	public PoopwoodSlabBlock(PoopModModElements instance) {
		super(instance, 31);
	}
