...
public class PoopwoodLeavesBlock extends PoopModModElements.ModElement {
	@ObjectHolder("poop_mod:poopwood_leaves")
	public static final Block block = null;
	public PoopwoodLeavesBlock(PoopModModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("poopwood_leaves");
		}
