...
public class PoopwoodStairsBlock extends PoopModModElements.ModElement {
	@ObjectHolder("poop_mod:poopwood_stairs")
	public static final Block block = null;
	public PoopwoodStairsBlock(PoopModModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("poopwood_stairs");
		}
