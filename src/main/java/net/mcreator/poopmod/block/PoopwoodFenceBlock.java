...
public class PoopwoodFenceBlock extends PoopModModElements.ModElement {
	@ObjectHolder("poop_mod:poopwood_fence")
	public static final Block block = null;
	public PoopwoodFenceBlock(PoopModModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("poopwood_fence");
		}
