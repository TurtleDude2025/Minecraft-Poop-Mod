...
public class PoopwoodWoodBlock extends PoopModModElements.ModElement {
	@ObjectHolder("poop_mod:poopwood_wood")
	public static final Block block = null;
	public PoopwoodWoodBlock(PoopModModElements instance) {
		super(instance, 26);
	}
