...
public class PoopwoodPlanksBlock extends PoopModModElements.ModElement {
	@ObjectHolder("poop_mod:poopwood_planks")
	public static final Block block = null;
	public PoopwoodPlanksBlock(PoopModModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("poopwood_planks");
		}
