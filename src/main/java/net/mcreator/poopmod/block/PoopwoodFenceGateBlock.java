...
public class PoopwoodFenceGateBlock extends PoopModModElements.ModElement {
	@ObjectHolder("poop_mod:poopwood_fence_gate")
	public static final Block block = null;
	public PoopwoodFenceGateBlock(PoopModModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("poopwood_fence_gate");
		}
