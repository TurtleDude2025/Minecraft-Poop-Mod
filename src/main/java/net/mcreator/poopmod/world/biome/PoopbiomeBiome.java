...
package net.mcreator.poopmod.world.biome;
...
public class PoopbiomeBiome extends PoopModModElements.ModElement {
	public static Biome biome;
	public PoopbiomeBiome(PoopModModElements instance) {
		super(instance, 43);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-16751104).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-10079488).withGrassColor(-10079488).build();
				...
				event.getRegistry().register(biome.setRegistryName("poop_mod:poopbiome"));
			}
		}
	}
	@Override
